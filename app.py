...
origins = [
    ...
    "https://teftis-portal-frontend-mzj1.vercel.app", # Eski adres de kalsın
    "https://teftis-portal-frontend-5u7j.vercel.app", # Eski adres de kalsın
    "http://localhost:3000"
]
...
# --- YENİ KULLANICI YÖNETİMİ API'LARI ---
